...
public class GeneralCanvasObject extends GeneralComponent {
    ...
    @RawPropertyMapping
    @PropertyDialogField(name = "Integer number property", type = ComponentPropertyType.TEXT_FIELD, unit = "I")
    private final IntegerProperty integerNumberProperty = new SimpleIntegerProperty(this,INTEGER_PROPERTY, 10);

    @RawPropertyMapping
    @PropertyDialogField(name = "Double number property", type = ComponentPropertyType.TEXT_FIELD, unit = "D")
    private final DoubleProperty doubleNumberProperty = new SimpleDoubleProperty(this, DOUBLE_PROPERTY, 10.21);

    @RawPropertyMapping
    @PropertyDialogField(name = "Float number property", type = ComponentPropertyType.TEXT_FIELD, unit = "F")
    private final FloatProperty floatNumberProperty = new SimpleFloatProperty(this, FLOAT_PROPERTY, 10.21f);

    @RawPropertyMapping
    @PropertyDialogField(name = "Check box property", type = ComponentPropertyType.CHECK_BOX, unit = "Check to be checked")
