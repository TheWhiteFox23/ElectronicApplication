...
public class CoupledInductor extends GeneralComponent {
    ...
    @RawPropertyMapping
    @PropertyDialogField(name = "coupled_inductor.inductance_l1", type = ComponentPropertyType.TEXT_FIELD, unit = "H")
    private final DoubleProperty inductance_l1 = new SimpleDoubleProperty(this, INDUCTANCE_L1, 1);

    @RawPropertyMapping
    @PropertyDialogField(name = "coupled_inductor.initial_condition_l1", type = ComponentPropertyType.TEXT_FIELD, unit = "A")
    private final DoubleProperty initial_condition_l1 = new SimpleDoubleProperty(this, INITIAL_CONDITION_L1, 0);

    @RawPropertyMapping
    @PropertyDialogField(name = "coupled_inductor.inductance_l2", type = ComponentPropertyType.TEXT_FIELD, unit = "H")
    private final DoubleProperty inductance_l2 = new SimpleDoubleProperty(this, INDUCTANCE_L2, 1);

    @RawPropertyMapping
    @PropertyDialogField(name = "coupled_inductor.initial_condition_l2", type = ComponentPropertyType.TEXT_FIELD, unit = "A")
