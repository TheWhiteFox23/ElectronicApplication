...
public class CanvasMouseEvent extends Event {
    ...
    public static final EventType<CanvasMouseEvent> OBJECT_MOVING = new EventType<>(Event.ANY, "OBJECT_MOVING");
    public static final EventType<CanvasMouseEvent> OBJECT_MOVED = new EventType<>(Event.ANY, "OBJECT_MOVED");
